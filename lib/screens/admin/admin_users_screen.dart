...
class _AdminUsersScreenState extends ConsumerState<AdminUsersScreen>
  ...
  Widget build(BuildContext context) {
    ...
    debugPrint(
        '👥 AdminUsersScreen: Dark mode: ${ThemeManager.of(context).themeManager}');
  ...
  Widget _buildAllUsersList() {
    ...
    return ListView.builder(
      ...
      itemBuilder: (context, index) {
        ...
        debugPrint(
            '👥 AdminUsersScreen: Building user card $index for all users (type: $userType)');
  ...
  Widget _buildUserCard(
    ...
    switch (status) {
      case 'verified':
        statusColor =
            ThemeManager.of(context).successColor; // Green for verified
        break;
      case 'pending':
        statusColor =
            ThemeManager.of(context).warningColor; // Orange for pending
        break;
      case 'suspended':
      ...
      default:
        statusColor =
            ThemeManager.of(context).textSecondary; // Gray for unknown
    }
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    if (user['service'] != null)
                      _buildDetailRow('Service', user['service']!),

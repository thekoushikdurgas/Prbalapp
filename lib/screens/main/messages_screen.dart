...
class _MessagesScreenState extends ConsumerState<MessagesScreen> with TickerProviderStateMixin {
  ...
  Widget build(BuildContext context) {
    ...
    debugPrint('💬 MessagesScreen: Dark mode: ${ThemeManager.of(context).themeManager}');
            ...
            children: [
              ...
              Expanded(
                child: FadeTransition(
                  ...
                  child: _isInChat ? _buildChatView() : _buildConversationsView(),
                ),
              ),
            ],
          ),
      ...
      child: Row(
        children: [
          ...
          if (_isInChat) ...[
            ...
            _buildActionButton(Prbal.plus, ThemeManager.of(context).primaryColor),
          ],
        ],
      ),
    );
                ...
                children: [
                  Container(
                    ...
                    decoration: BoxDecoration(
                      ...
                      boxShadow: [
                        BoxShadow(
                          color: ThemeManager.of(context).successColor.withValues(alpha: 0.4),
                          blurRadius: 4,
                          spreadRadius: 1,
                        ),
                      ],
  ...
  Widget _buildConversationItem(
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        gradient: hasUnread ? ThemeManager.of(context).accent1Gradient : ThemeManager.of(context).surfaceGradient,
        borderRadius: BorderRadius.circular(20.r),
        boxShadow: hasUnread ? ThemeManager.of(context).primaryShadow : ThemeManager.of(context).subtleShadow,
        border: Border.all(
          color: hasUnread
                  ...
                  children: [
                    Container(
                      ...
                      decoration: BoxDecoration(
                        ...
                        boxShadow:
                            isOnline ? ThemeManager.of(context).primaryShadow : ThemeManager.of(context).subtleShadow,
                      ),
                      child: ClipRRect(
                        borderRadius: BorderRadius.circular(28.r),
                        child: Image.network(
                    ...
                    children: [
                          ...
                          Expanded(
                            child: Text(
                              ...
                              style: TextStyle(
                                fontSize: 16.sp,
                                fontWeight: FontWeight.w700,
                                color: hasUnread ? Colors.white : ThemeManager.of(context).textPrimary,
                              ),
                              maxLines: 1,
                              overflow: TextOverflow.ellipsis,
                            ),
                      ...
                      Container(
                        ...
                        decoration: BoxDecoration(
                          ...
                          border: Border.all(
                            color:
                                hasUnread ? Colors.white.withValues(alpha: 0.2) : ThemeManager.of(context).borderColor,
                            width: 1,
                          ),
                        ),
                        child: Row(
                          children: [
                            Icon(
                              Prbal.messageCircle,
                              size: 12.sp,
                              color: hasUnread ? Colors.white70 : ThemeManager.of(context).textTertiary,
                            ),
                            SizedBox(width: 6.w),
                            Expanded(
                              child: Text(
                                ...
                                style: TextStyle(
                                  fontSize: 13.sp,
                                  color: hasUnread ? Colors.white70 : ThemeManager.of(context).textSecondary,
                                  fontWeight: FontWeight.w500,
                                ),
                                maxLines: 1,
                                overflow: TextOverflow.ellipsis,
              ...
              child: Column(
                ...
                children: [
                  ...
                  Container(
                    ...
                    decoration: BoxDecoration(
                      gradient:
                          isMe ? ThemeManager.of(context).primaryGradient : ThemeManager.of(context).surfaceGradient,
                      ...
                      boxShadow: isMe ? ThemeManager.of(context).primaryShadow : ThemeManager.of(context).subtleShadow,
                      border: Border.all(
                        color: isMe
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Text(
                          ...
                          style: TextStyle(
                            fontSize: 14.sp,
                            color: isMe ? Colors.white : ThemeManager.of(context).textPrimary,
                            height: 1.4,
                            fontWeight: FontWeight.w500,
                          ),
                        ),
                        ...
                        Row(
                          ...
                          children: [
                            Icon(
                              Prbal.clock,
                              size: 10.sp,
                              color: isMe ? Colors.white.withValues(alpha: 0.7) : ThemeManager.of(context).textTertiary,
                            ),
                            SizedBox(width: 4.w),
                            Text(
                              messageTime,
                              style: TextStyle(
                                fontSize: 11.sp,
                                color:
                                    isMe ? Colors.white.withValues(alpha: 0.7) : ThemeManager.of(context).textTertiary,
                                fontWeight: FontWeight.w500,
                              ),
                            ),
                            if (isMe) ...[

...
class _TermsOfServiceBottomSheetState extends State<TermsOfServiceBottomSheet>
  ...
  Widget build(BuildContext context) {
    ...
    debugPrint('📋 [Terms] Background: ${themeManager.backgroundColor}');
    debugPrint('📋 [Terms] Surface: ${themeManager.surfaceColor}');
    debugPrint('📋 [Terms] Accent: ${themeManager.accent2}');
              ...
              Container(
                ...
                decoration: BoxDecoration(
                  gradient: LinearGradient(
                    colors: [
                      themeManager.accent2,
                      themeManager.accent2.withValues(alpha: 204),
                    ],
                  ...
                  boxShadow: [
                    BoxShadow(
                      color: themeManager.accent2.withValues(alpha: 51),
                      blurRadius: 8.r,
                      offset: Offset(0, 2.h),
                    ),
                  ],
    ...
    return CustomScrollView(
      ...
      slivers: [
        ...
        if (_searchQuery.isEmpty)
          SliverToBoxAdapter(
            child: _buildIntroductionSection(themeManager),
          ),
        ...
        SliverList(
          delegate: SliverChildBuilderDelegate(
            (context, index) {
              ...
              return _buildTermsSection(themeManager, section, index);
            },
        ...
        // Contact section
        SliverToBoxAdapter(
          child: _buildContactSection(themeManager),
        ),
  ...
  Widget _buildIntroductionSection(ThemeManager themeManager) {
    return Container(
  ...
  Widget _buildTermsSection(ThemeManager themeManager, TermsSection section, int sectionIndex) {
    return Container(
      margin: EdgeInsets.fromLTRB(20.w, 0, 20.w, 16.h),
      decoration: BoxDecoration(
        gradient: themeManager.surfaceGradient,
      ...
      child: Column(
        ...
        children: [
          ...
          ...section.items.asMap().entries.map((entry) {
            ...
            return _buildTermsItem(themeManager, item, globalIndex, section.color);
          }),
        ],
      ),
    );
  ...
  Widget _buildTermsItem(ThemeManager themeManager, TermsItem item, int index, Color accentColor) {
    ...
    return Container(
      decoration: BoxDecoration(
        border: Border(
          top: BorderSide(
            color: themeManager.borderColor.withValues(alpha: 26),
          ),
        ),
      ),
      child: Column(
  ...
  Widget _buildContactSection(ThemeManager themeManager) {
    return Container(
              ...
              Expanded(
                child: OutlinedButton.icon(
                  ...
                  style: OutlinedButton.styleFrom(
                    ...
                    side: BorderSide(
                      color: themeManager.successColor.withValues(alpha: 128),
                    ),

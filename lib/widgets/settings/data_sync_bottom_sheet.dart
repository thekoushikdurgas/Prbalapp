...
class _DataSyncBottomSheetState extends State<DataSyncBottomSheet> with TickerProviderStateMixin, ThemeAwareMixin {
  ...
  Widget build(BuildContext context) {
    ...
    debugPrint('🔄 [DataSync] Background: ${themeManager.backgroundColor}');
    debugPrint('🔄 [DataSync] Primary: ${themeManager.primaryColor}');
    debugPrint('🔄 [DataSync] Info: ${themeManager.infoColor}');
          ...
          Container(
            ...
            decoration: BoxDecoration(
              gradient: LinearGradient(
                colors: [
                  themeManager.primaryColor.withValues(alpha: 179),
  ...
  Widget _buildSyncStatus(ThemeManager themeManager) {
    final statusColor = _hasValidTokens
        ? (_isSyncing ? themeManager.warningColor : themeManager.successColor)
  ...
  Widget _buildContent(ThemeManager themeManager) {
    return SingleChildScrollView(
      ...
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          if (!_hasValidTokens) _buildAuthenticationSection(themeManager),
          if (_hasValidTokens) ...[
            _buildUserDetailsSection(themeManager),
            SizedBox(height: 24.h),
            _buildTokenStatusSection(themeManager),
            SizedBox(height: 24.h),
            _buildSyncOptionsSection(themeManager),
            SizedBox(height: 24.h),
            _buildSyncTypesSection(themeManager),
            SizedBox(height: 24.h),
            _buildSyncSettingsSection(themeManager),
          ],
        ],
      ),
    );
  ...
  Widget _buildAuthenticationSection(ThemeManager themeManager) {
    return Container(
      ...
      decoration: BoxDecoration(
        gradient: LinearGradient(
          colors: [
            ...
            themeManager.errorLight.withValues(alpha: 13),
          ],
        ),
  ...
  Widget _buildUserDetailsSection(ThemeManager themeManager) {
    return Container(
      padding: EdgeInsets.all(20.w),
      decoration: BoxDecoration(
        gradient: themeManager.surfaceGradient,
  ...
  Widget _buildTokenStatusSection(ThemeManager themeManager) {
    return Container(
      padding: EdgeInsets.all(20.w),
      decoration: BoxDecoration(
        gradient: themeManager.surfaceGradient,
  ...
  Widget _buildTokenItem(ThemeManager themeManager, String title, String? token, Color color) {
    final hasToken = token != null && token.isNotEmpty;

    return Container(
      padding: EdgeInsets.all(12.w),
      decoration: BoxDecoration(
        color: hasToken ? color.withValues(alpha: 26) : themeManager.errorColor.withValues(alpha: 26),
        borderRadius: BorderRadius.circular(8.r),
        border: Border.all(
          color: hasToken ? color.withValues(alpha: 128) : themeManager.errorColor.withValues(alpha: 128),
        ),
      ),
      child: Row(
        children: [
          Icon(
            ...
            color: hasToken ? color : themeManager.errorColor,
            size: 16.sp,
          ),
          SizedBox(width: 8.w),
          Expanded(
  ...
  Widget _buildSyncOptionsSection(ThemeManager themeManager) {
    return Container(
      padding: EdgeInsets.all(20.w),
      decoration: BoxDecoration(
        gradient: themeManager.surfaceGradient,
  ...
  Widget _buildSyncTypesSection(ThemeManager themeManager) {
    final syncTypes = [
      {
        'id': 'profile',
        'title': 'Profile Data',
            ...
            return Container(
              ...
              child: InkWell(
                ...
                child: Container(
                  padding: EdgeInsets.all(12.w),
                  decoration: BoxDecoration(
                    color: isSelected ? color.withValues(alpha: 26) : themeManager.inputBackground,
                    borderRadius: BorderRadius.circular(8.r),
                    border: Border.all(
                      color: isSelected ? color.withValues(alpha: 128) : themeManager.borderColor.withValues(alpha: 77),
                    ),
                  ),
                  child: Row(
                    children: [
                      Container(
                        ...
                        decoration: BoxDecoration(
                          ...
                          border: Border.all(
                            color: isSelected ? color : themeManager.borderColor,
                            width: 2,
                          ),
  ...
  Widget _buildSyncSettingsSection(ThemeManager themeManager) {
    return Container(
      padding: EdgeInsets.all(20.w),
      decoration: BoxDecoration(
        gradient: LinearGradient(
        ...
        children: [
          ...
          Expanded(
            ...
            child: ElevatedButton(
              onPressed:
                  !_hasValidTokens || _isSyncing || _selectedSyncTypes.isEmpty ? null : () => _startSync(themeManager),
              style: ElevatedButton.styleFrom(
                backgroundColor: themeManager.primaryColor,
                foregroundColor: themeManager.textInverted,
                shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(12.r)),
  ...
  void _startSync(ThemeManager themeManager) async {
    setState(() {
      _isSyncing = true;
      _syncStatus = 'Syncing...';
      _syncProgress.clear();

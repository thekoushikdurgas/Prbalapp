...
class _HelpCenterBottomSheetState extends State<HelpCenterBottomSheet> with TickerProviderStateMixin, ThemeAwareMixin {
  ...
  Widget build(BuildContext context) {
    ...
    debugPrint('🆘 [HelpCenter] Background: ${themeManager.backgroundColor}');
    debugPrint('🆘 [HelpCenter] Surface: ${themeManager.surfaceColor}');
    debugPrint('🆘 [HelpCenter] Primary: ${themeManager.primaryColor}');
        ...
        return Opacity(
          ...
          child: Container(
            ...
            decoration: BoxDecoration(
              ...
              boxShadow: [
                BoxShadow(
                  color: themeManager.shadowDark.withValues(alpha: 77),
                  blurRadius: 20.r,
                  offset: Offset(0, -4.h),
                ),
              ],
    ...
    return CustomScrollView(
      ...
      slivers: [
        if (_searchQuery.isEmpty) ...[
          ...
          SliverToBoxAdapter(
            child: _buildQuickActions(themeManager),
          ),
        ],
        ...
        SliverList(
          delegate: SliverChildBuilderDelegate(
            (context, index) {
              ...
              return _buildHelpCategory(themeManager, category, index);
            },
  ...
  Widget _buildHelpCategory(ThemeManager themeManager, HelpCategory category, int categoryIndex) {
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          ...category.items.asMap().entries.map((entry) {
            ...
            return _buildFAQItem(themeManager, item, globalIndex, category.color);
          }),
        ],
      ),
    );
  ...
  Widget _buildFAQItem(ThemeManager themeManager, FAQItem item, int index, Color accentColor) {

...
class AppVersionWidget extends StatelessWidget with ThemeAwareMixin {
  ...
  Widget build(BuildContext context) {
    ...
    debugPrint('📱 AppVersionWidget: → Text Colors - Primary: ${themeManager.textPrimary}, Secondary: ${themeManager.textSecondary}, Tertiary: ${themeManager.textTertiary}');
    debugPrint('📱 AppVersionWidget: → Neutral Colors: ${themeManager.neutral400}, ${themeManager.neutral500}, ${themeManager.neutral600}');

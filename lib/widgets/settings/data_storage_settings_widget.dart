...
class DataStorageSettingsWidget extends StatelessWidget with ThemeAwareMixin {
  ...
  Widget build(BuildContext context) {
    debugPrint('⚙️ DataStorageSettingsWidget: Building data & storage settings with comprehensive ThemeManager integration');
    ...
    debugPrint('⚙️ DataStorageSettingsWidget: → Accent Colors: ${themeManager.accent1}, ${themeManager.accent2}, ${themeManager.accent3}');
    debugPrint('⚙️ DataStorageSettingsWidget: → Status Colors - Success: ${themeManager.successColor}, Warning: ${themeManager.warningColor}, Error: ${themeManager.errorColor}, Info: ${themeManager.infoColor}');
    ...
    debugPrint('⚙️ DataStorageSettingsWidget: → Text Colors - Primary: ${themeManager.textPrimary}, Secondary: ${themeManager.textSecondary}');

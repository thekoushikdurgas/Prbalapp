...
/// ProfileFormFieldWidget - Reusable form field for profile editing
///
/// This widget provides a consistent form field design for profile forms.
/// Features:
...
class ProfileFormFieldWidget extends ConsumerWidget {
  const ProfileFormFieldWidget({
    ...
    this.required = true,
    this.validator,
    this.userTypeColor = const Color(0xFF4299E1),
  });
  ...
  // Color ThemeManager.of(context).getUserTypeColor(UserType userType) {

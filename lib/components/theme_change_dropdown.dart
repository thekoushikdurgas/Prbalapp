...
import 'package:prbal/utils/constants/string/string_constants.dart';
...
class ThemeChangeDropdown extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    debugPrint('🎨 ThemeChangeDropdown: Screen size - width: ${screenSize.width}, height: ${screenSize.height}');

    return BlocProvider(
      create: (context) {
        debugPrint('🎨 ThemeChangeDropdown: Creating RadioCubit for state management');
        return RadioCubit();
      },
  ...
  Widget _darkRadio(String state, BuildContext context) {
    ...
    debugPrint('🎨 ThemeChangeDropdown: Dark theme option selected: $isSelected');
  ...
  Widget _lightRadio(String state, BuildContext context) {
    ...
    debugPrint('🎨 ThemeChangeDropdown: Light theme option selected: $isSelected');
  ...
  Widget _systemRadio(String state, BuildContext context) {
    debugPrint('🎨 ThemeChangeDropdown: Building system default theme radio option');

    final isSelected = state == StringConstants.sysRadio;
    debugPrint('🎨 ThemeChangeDropdown: System default theme option selected: $isSelected');
    ...
    return ConstrainedBox(
      ...
      child: ListTile(
        ...
        leading: Radio(
          ...
          groupValue: state,
          onChanged: (value) {
            debugPrint('🎨 ThemeChangeDropdown: System default theme radio selected');
            context.read<RadioCubit>().changeValue(value.toString());
          },
        ),
        title: Text(
  ...
  Row _actions(BuildContext context, String state) {
    debugPrint('🎨 ThemeChangeDropdown: Building action buttons with state: $state');
  ...
  TextButton _okTextButton(String state, BuildContext context) {
    ...
    return TextButton(
      onPressed: () {
        debugPrint('🎨 ThemeChangeDropdown: OK button pressed with state: $state');
  ...
  TextButton _cancelTextButton(BuildContext context) {
    ...
    return TextButton(
      onPressed: () {
        debugPrint('🎨 ThemeChangeDropdown: Cancel button pressed - dismissing dialog');
        Navigator.pop(context);
      },
      child: Text(

...
class TextLabelLargeTitle extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    debugPrint('📝 TextLabelLargeTitle: Current theme brightness: ${theme.brightness}');
    debugPrint('📝 TextLabelLargeTitle: Label style - fontSize: ${labelStyle?.fontSize}, color: ${labelStyle?.color}');
    ...
    return Text(
      ...
      style: labelStyle, // Use theme's labelLarge style for consistent appearance
    );
  }
}

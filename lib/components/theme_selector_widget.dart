...
class ThemeSelectorWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    debugPrint('🎨 ThemeSelectorWidget: Current theme is ${isDark ? 'dark' : 'light'}');

    return BlocBuilder<ThemeCubit, ThemeMode>(
      builder: (context, themeMode) {
        debugPrint('🎨 ThemeSelectorWidget: Current ThemeMode state: $themeMode');
          ...
          child: Column(
            ...
            children: [
              ...
              _buildThemeOption(
                ...
                onTap: () {
                  debugPrint('🎨 ThemeSelectorWidget: User selected System Default theme');
              ...
              _buildThemeOption(
                ...
                onTap: () {
                  debugPrint('🎨 ThemeSelectorWidget: User selected Light theme');
              ...
              _buildThemeOption(
                ...
                onTap: () {
                  debugPrint('🎨 ThemeSelectorWidget: User selected Dark theme');
  ...
  Widget _buildThemeOption(
    ...
    debugPrint('🎨 ThemeSelectorWidget: Building theme option - $title (selected: $isSelected)');
        ...
        child: Container(
          ...
          decoration: BoxDecoration(
            ...
            border: Border.all(
              ...
              color: isSelected ? const Color(0xFF3B82F6) : (isDark ? Colors.grey[700]! : Colors.grey[300]!),
          ...
          child: Row(
            children: [
              ...
              Container(
                ...
                decoration: BoxDecoration(
                  color: isSelected ? const Color(0xFF3B82F6) : (isDark ? Colors.grey[700] : Colors.grey[200]),
                  ...
                  children: [
                    ...
                    Text(
                      ...
                      style: TextStyle(
                        ...
                        color: isSelected ? const Color(0xFF3B82F6) : (isDark ? Colors.white : const Color(0xFF2D3748)),
                      ),
                    ),
              ...
              if (isSelected) ...[
                Builder(
                  builder: (context) {
                    debugPrint('🎨 ThemeSelectorWidget: Showing check icon for selected option - $title');
                    return Icon(
                      LineIcons.check,
